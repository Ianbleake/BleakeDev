...
export default function GradePage(): React.ReactElement {
  ...
  const { degree, degreeLoading } = useDegree(gradeId,isDeegre);
  const { certification, certificationLoading } = useCertification(gradeId,isCertification);

  if(degreeLoading || certificationLoading ){
    <GradePageSkeleton/>
  }
      ...
      <div className="flex flex-col gap-4">
        ...
        <Card className="px-4 border-b border-gray-200 pb-4 flex flex-row items-center justify-between">
            ...
            <div className="flex flex-1 flex-col gap-2">
              ...
              <h2 className="text-gray-900 font-semibold text-xl">{ isDeegre ? degree?.degree : certification?.title || "No title" }</h2> 
              ...
              <div className="grid grid-cols-3 gap-4 my-2">
                ...
                <div className="flex flex-row gap-2 items-center">
                  ...
                  <p className="text-gray-400 text-md font-normal"> 
                    { isDeegre ? degree?.institution : certification?.issuer || "-" }
                  </p>
                </div>
                ...
                <div className="flex flex-row gap-2 items-center">
                  ...
                  <p className="text-gray-400 text-sm font-normal"> 
                    { isDeegre ? degree?.period : certification?.date || "-" }
                  </p>
                </div>
                ...
                <div className="flex flex-row gap-2 items-center col-span-3">
                  ...
                  <p className="text-gray-400 text-sm font-normal"> 
                    { isDeegre ? degree?.description : certification?.description || "No description" }
                  </p>
                </div>
            ...
            { isDeegre ? (
              ...
              (
                ...
                <div className="flex flex-col gap-3 items-center justify-center col-span-2">
                  ...
                  <p className="text-gray-300 text-sm">This grade does`t have achievements or someting when wrong.</p>
                </div>
              )
