      ...
      <Dialog open={open} onOpenChange={handleDialogChange}>
        <DialogContent>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="border border-gray-200 shadow-md rounded-md bg-gray-50 flex flex-col my-4">
            ...
            <DialogFooter>
              <Button type="button" disabled={isSubmitting || isPending} variant="outline" onClick={() => handleDialogChange(false)}>
                <RiArrowGoBackFill />
                Cancel
              </Button>
